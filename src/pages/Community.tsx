    ...
    <div className="min-h-screen bg-background community-page">
      ...
      <main className="pt-24 pb-12 relative">
        ...
        <div className="mx-auto px-6 max-w-[1100px]">
          ...
          {/* 검색창 - 스크롤 시 숨김 */}
          <div className={`transition-all duration-300 ${isScrolled ? 'opacity-0 h-0 overflow-hidden mb-0' : 'opacity-100 h-auto mb-0'}`}>
      ...
      {/* 필터 및 정렬 - 전체 너비 sticky (Navbar 바로 아래 고정) */}
      <div
                      ...
                      <div className="flex items-center justify-between pt-4">
                        ...
                        <div className="flex items-center gap-2">
                          <Button
                            ...
                            className={`${getUserVote(post.id) === 1
                          ...
                          <Button
                            ...
                            className={`${isBookmarked(post.id)
