-- Guide 14 Update Part 3 (v7 FINAL): Steps 6-11 & Prompts
-- Fixes literal '\n' characters being displayed in UI
-- Uses $$ dollar-quoted strings with ACTUAL line breaks for all text fields
-- (goal, done_when, why_matters, tips, checklist, content)
...
- [ ] 최소 10개 프롬프트를 카테고리별로 정리했는가?
- [ ] 각 프롬프트에 도구명, 성공률, 용도를 기록했는가?
