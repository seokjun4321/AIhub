-- Guide 14 Update Part 3 (v8 FINAL): Steps 6-11 & Prompts
-- Fixes formatted text issues:
-- 1. Uses $$ strings for newlines
-- 2. ESCAPES tildes (~) as \~ to prevent Markdown strikethrough
