-- Guide 14 Update Part 3 (v5 FINAL): Steps 6-11 & Prompts
-- Correctly handles JSON escaping using $$ strings.
-- Fixed text formatting: replaced literal '\n' with actual newlines using $$ strings for text columns.
